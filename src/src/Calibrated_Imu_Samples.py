...
arquivo = open('/home/robottraining03/Ararajuba/src/Extras/IMU-SensorTag/src/params/ImuData.csv')
...
media =np.array([(MagX[i]/center[0])**2 for i in range(len(MagX[0:280]))])
mi = np.average(media)
var = np.var(media)
sigma = sqrt(var)
print(mi)
